...
class DoctorListViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,CLLocationManagerDelegate,GMSMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.getServiceHospital(page_index: pageIndexHospital, type: "bs")
    ...
    func pullToRefresh() -> Void {
        ...
        self.getServiceHospital(page_index: self.pageIndexHospital, type: "bs")
    }
    ...
    func mapView(_ mapView: GMSMapView, didTapInfoWindowOf marker: GMSMarker) {
        ...
        self.performSegue(withIdentifier: "PushToDoctorDetail", sender: self)
    }
                ...
                if (resultDictionary["status"] as! NSNumber) == 1 {
                    ...
                    if listItem.count > 0 {
                        ...
                        DispatchQueue.global().async {
                            self.loadMoreService(page_index: self.pageIndexHospital, type: "bs")
                        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "PushToDoctorDetail" {
