...
class HospitalListViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,CLLocationManagerDelegate,GMSMapViewDelegate {
...
extension HospitalListViewController {
    func didTapGuideView(_ sender: UITapGestureRecognizer) {
        ...
        Defaults[.isShowGuideHospital] = true
    }
}
...
extension HospitalListViewController {
    func setupAllSubviews() {
        ...
        guideView.alpha = Defaults[.isShowGuideHospital] ? 0 : 1
